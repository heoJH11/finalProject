...
public class ArticlePage2<T> {
	...
	//전체글 수
		...
		public ArticlePage2(int total, int currentPage, int size
				, List<T> content, String keyword, String direction, String searchKey) {
			...
			pagingArea += "<a href='javascript:"+direction+"(\""+(this.startPage-5)+"\",\""+this.keyword+"\",\""+this.searchKey+"\")' aria-controls='example2' data-dt-idx='0' tabindex='0' ";
			...
			pagingArea += "<li class='paginate_button page-item ";
				...
				pagingArea += "'>";
				pagingArea += "<a href='javascript:"+direction+"(\""+pNo+"\",\""+this.keyword+"\",\""+this.searchKey+"\")' aria-controls='example2' data-dt-idx='1' tabindex='0' ";
			...
			pagingArea += "href='javascript:"+direction+"(\""+(this.startPage+5)+"\",\""+this.keyword+"\",\""+this.searchKey+"\")' aria-controls='example2' data-dt-idx='7' ";
