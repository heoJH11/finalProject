...
public class ArticlePage3<T> {
		...
		public ArticlePage3(int total, int currentPage, int size, List<T> content, String keyword, String selectColumn) {
			...
			pagingArea += "<ul class='pagination flex-wrap pagination-rounded-flat pagination-primary'>";
			pagingArea += "<li class='paginate_button page-item previous'"; 
			if(this.startPage<6) {
				pagingArea += "style='display:none;' ";
			}
			pagingArea += "id='example2_previous'>";
			pagingArea += "<a href='"+this.url+"?currentPage="+(this.startPage-5)+"&keyword="+this.keyword+"&selectColumn="+this.selectColumn+"' aria-controls='example2' data-dt-idx='0' tabindex='0' ";
			pagingArea += "class='page-link'><i class=\"ti-angle-double-left\"></i></a></li>";
			...
			pagingArea += "<li class='paginate_button page-item ";
				...
				pagingArea += "'>";
				pagingArea += "<a href='"+this.url+"?currentPage="+pNo+"&keyword="+this.keyword+"&selectColumn="+this.selectColumn+"' aria-controls='example2' data-dt-idx='1' tabindex='0' ";
			...
			pagingArea += "href='"+this.url+"?currentPage="+(this.startPage+5)+"&keyword="+this.keyword+"&selectColumn="+this.selectColumn+"' aria-controls='example2' data-dt-idx='7' ";
			pagingArea += "tabindex='0' class='page-link'><i class=\"ti-angle-double-right\"></i></a></li>";
			pagingArea += "</ul>";
			pagingArea += "</div>";
			pagingArea += "</div>";
		}//end 생성자
