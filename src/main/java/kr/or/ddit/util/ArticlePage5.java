...
public class ArticlePage5<T> {
		...
		public ArticlePage5(int total, int currentPage, int size, List<T> content, String keyword, String proId) {
			...
			pagingArea += "<ul class='pagination pagination-rounded-flat pagination-primary'>";
			pagingArea += "<li class='paginate_button page-item previous'"; 
			if(this.startPage<6) {
				pagingArea += "style='display:none;' ";
			}
			pagingArea += "id='example2_previous'>";
			pagingArea += "<a href='"+this.url+"?proId="+this.proId+"&currentPage="+(this.startPage-5)+"' aria-controls='example2' data-dt-idx='0' tabindex='0' ";
			...
			pagingArea += "<li class='paginate_button page-item ";
				...
				pagingArea += "'>";
				pagingArea += "<a href='"+this.url+"?proId="+this.proId+"&currentPage="+pNo+"' aria-controls='example2' data-dt-idx='1' tabindex='0' ";
			...
			pagingArea += "href='"+this.url+"?proId="+this.proId+"&currentPage="+(this.startPage+5)+"' aria-controls='example2' data-dt-idx='7' ";
		...
		public String toString() {
			return "ArticlePage [total=" + total + ", currentPage=" + currentPage + ", totalPages=" + totalPages
					...
					+ ", proId=" + proId + ",content=" + content + ", pagingArea=" + pagingArea + "]";
		}
