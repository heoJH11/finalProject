...
public class ArticlePage5<T> {
		...
		public ArticlePage5(int total, int currentPage, int size, List<T> content, String keyword , String type) {
		...
		//프로 마이페이지용 메소드
		public ArticlePage5(int total, int currentPage, int size, List<T> content, String keyword, int totalPrice) {
			//size : 한 화면에 보여질 목록의 행 수
			this.total = total;//753
			this.currentPage = currentPage;//1
			this.content = content;
