...
$(function(){
 ...
 <div class="card card-primary"> 
		...
		<!-- 제목 -->
		<div >
			<img alt="faq" src="../resources/images/궁금2.png" style="width:100px; height:auto; margin:20px 0 20px 740px;">
			<h2 id="faqTitle" style="text-align:center; font-family: 'seolleimcool-SemiBold'; color:#4e4c7c; text-shadow: -2px 0px white, 0px 2px white, 2px 0px white, 0px -2px white;">FAQ 등록</h2>
	...
	<form name="frm" id="frm" action="/faq/create?register" method="post">
		<div class="card-body">
			...
			<div class="form-group">
				...
				<div id="ckFaqAnswer" style="height:150px;" style="display:none;"></div>
		...
		<div class="card-footer">
			<button type="button" id="insert" class="btn btn-inverse-primary">등록</button>
