                    ...
                    <div class="card-body" >
                      ...
                      <div class="row">
                        <div class="col-8 text-white">
                          <h3>공지사항 상세</h3> 
                          <p class="text-white font-weight-500 mb-0">Details of the notice.</p>
                        </div>
...
<div class="col-md-12 grid-margin stretch-card">
              <div class="card" style="font-family: 'GmarketSansMedium';">
                <div class="card-body" >
...
<!--     </p> -->
    ...
    <p id="p1">
        ...
        <button type="button" id="delete" class="btn btn-inverse-danger">삭제</button>
        <button type="button" id="list" class="btn btn-inverse-secondary">목록</button>
    </p>
	</c:if>
	
		<c:if test="${empty sessionScope.admSession}">
    	<button type="button" id="list2" class="btn btn-inverse-primary">목록</button>
    	</c:if>
    
    <p id="p2" style="display:none;">
        <button type="button" id="confirm" class="btn btn-inverse-primary">확인</button>
        <button type="button" id="cancel" class="btn btn-inverse-secondary">취소</button>
    </p>
</div>	
