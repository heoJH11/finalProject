...
$(function(){
	...
	$("#searchBtn").on("click",function(){
		...
		$.ajax({
	        url : "/manage/oneInqryNoAnswerList",
	        contentType : "application/json; charset=utf-8",
	        data : JSON.stringify(data),
	        type : "post",
	        dataType : "json",
	...
	<div class="card-body" style="font-family: 'GmarketSansMedium';">
		<ul class="nav nav-tabs" role="tablist">
			<li class="nav-item" role="presentation"><a class="nav-link"
				...
				href="/manage/oneInqryList" aria-selected="true">전체</a></li>
			<li class="nav-item" role="presentation"><a
				class="nav-link active" id="noAnswer-tab" href="/manage/oneInqryNoAnswerList"
				aria-controls="noAnswer-1" aria-selected="false" tabindex="-1">미답변</a>
			</li>
			<li class="nav-item" role="presentation"><a class="nav-link"
				id="success-tab" 
				href="/manage/oneInqrySuccessList" aria-controls="success-1"
