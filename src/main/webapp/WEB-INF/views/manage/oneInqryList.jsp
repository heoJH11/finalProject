...
$(document).ready(function() {
    // [탈퇴]를 포함한 제목을 가진 행 숨기기
    $("td[id^='oneInqrySj']").each(function() {
        if ($(this).text().includes('[탈퇴]')) {
            $(this).parent('tr').hide();
        }
    });
});
        ...
        success : function(res){
           ...
           $.each(res.data.content, function(i,v){
              ...
              case "testAdmin" :
                 ...
                 str += "<td id='userId"+v.oneInqryNo+"'><a href='/oneInqry/oneInqryDetail?oneInqryNo="+v.oneInqryNo+"&userId="+v.userId+"'>"+v.userId+"</a></td>";
              ...
              default :
                 str += "<tr>";
                 str += "<td id='num"+v.oneInqryNo+"'>"+v.num+"</td>";
                    str += "<td id='userId" + v.oneInqryNo + "'><a href='/oneInqry/oneInqryDetail?oneInqryNo="+v.oneInqryNo+"'>" + v.userId + "</a></td>";
...
<div class="card" style="margin-top: 10px;">
      <div class="dropdown show"
            style="float: right; position: absolute;  margin : 19px 0 0 1195px;">
   ...
   <div class="card-body" style="font-family: 'GmarketSansMedium';">
      <ul class="nav nav-tabs" role="tablist">
         <li class="nav-item" role="presentation"><a
            class="nav-link active" id="all-tab" 
            aria-controls="all-1" href="/manage/oneInqryList"
            aria-selected="true">전체</a></li>
         <li class="nav-item" role="presentation"><a class="nav-link"
            id="noAnswer-tab" href="/manage/oneInqryNoAnswerList"
            aria-controls="noAnswer-1" aria-selected="false" tabindex="-1">미답변</a>
         </li>
         <li class="nav-item" role="presentation"><a class="nav-link"
            id="success-tab" href="/manage/oneInqrySuccessList"
