...
$(function(){
    ...
    $.ajax({
    	url : "/oneInqry/oneInqrySuccessList",
...
<div class="container col-lg-12">
	...
	<div>
				<!-- 제목 -->
		<div >
			<img alt="1대1문의" src="../resources/images/상담.png" style="width:100px; height:auto; margin:0 0 20px 730px;">
	...
	<div class="card-body" style="font-family: 'GmarketSansMedium';">
		<ul class="nav nav-tabs" role="tablist">
			<li class="nav-item" role="presentation"><a
				class="nav-link" id="all-tab" aria-controls="all-1" href="/manage/oneInqryList"
