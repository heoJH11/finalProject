...
<div class="tyn-aside tyn-aside-base">
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <ul class="tyn-list-links nav nav-tabs border-0" role="tablist">
                                        <li>
                                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#all-chats" aria-selected="true" role="tab">
                                                <!-- chat-square-text -->
                                        ...
                                        <li>
                                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#active-contacts" aria-selected="false" tabindex="-1" role="tab">
                                                <!-- person-check -->
                                        ...
                                        <li>
                                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#archived-chats" aria-selected="false" tabindex="-1" role="tab">
                                                <!-- archive -->
                                        ...
                                        <li>
                                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#spam-messages" aria-selected="false" tabindex="-1" role="tab">
                                                <!-- bookmark-x -->
                                        ...
                                        <li>
                                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#trash-bin" aria-selected="false" tabindex="-1" role="tab">
                                                <!-- trash -->
                ...
                </div></div></div></div><div class="simplebar-placeholder" style="width: auto; height: 844px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: hidden;"><div class="simplebar-scrollbar" style="height: 0px; display: none;"></div></div></div><!-- .tyn-aside-body -->
            </div>