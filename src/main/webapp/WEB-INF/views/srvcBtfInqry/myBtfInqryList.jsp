	...
	$("#searchBtn").on("click",function(){
		...
		$.ajax({
	        ...
	        success: function(res){
	            ...
	            str += "<tr><td colspan='5' style='font-size:13pt;'>'"+keyword+"' (으)로 검색된 결과가 "+res.total+"건 있습니다.</td></tr>";
	            $.each(res.content, function(i, v){
	...
	<div class="card-body">
		<ul class="nav nav-tabs" role="tablist">
			<li class="nav-item" role="presentation"><a style="font-family: 'GmarketSansLight';"
				class="nav-link active" id="all-tab" aria-controls="all-1" href="/srvcBtfInqry/myBtfInqryList"
