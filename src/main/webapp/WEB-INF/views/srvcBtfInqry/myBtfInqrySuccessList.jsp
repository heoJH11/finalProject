...
$(function(){
    ...
    $.ajax({
    	url : "/srvcBtfInqry/myBtfInqrySuccessList",
 	    ...
 	    success : function(res){
 	    	...
 	    	$("#S_divPaging").html("");
 	    	 var length = res.content.length;
	            if(length == 0){
	            	str += "<td colspan='5' style='font-family: GmarketSansLight; font-size:15pt;'>답변이 완료된 문의가 없습니다</td>";
	...
	<div class="card-body">
		<ul class="nav nav-tabs" role="tablist">
			...
			<li class="nav-item" role="presentation"><a class="nav-link active" style="font-family: 'GmarketSansLight';"
				id="success-tab" href="/srvcBtfInqry/myBtfInqrySuccessList"
				aria-controls="success-1" aria-selected="true" tabindex="-1">완료</a>
			</li>
		</ul>
		<!-- 전체 탭 -->
