...
$(function(){
    ...
    $.ajax({
    	url : "/srvcBtfInqry/myBtfInqryNoAnswerList",
 	    ...
 	    success : function(res){
            ...
            if(length == 0){
            	str = "<td colspan='5' style='font-family: GmarketSansLight; font-size:15pt;'>답변이 완료되지 않은 문의가 없습니다</td>"
	...
	<div class="card-body">
		<ul class="nav nav-tabs" role="tablist">
			<li class="nav-item" role="presentation"><a style="font-family: 'GmarketSansLight';"
				class="nav-link" id="all-tab" aria-controls="all-1" href="/srvcBtfInqry/myBtfInqryList"
