    ...
    $.ajax({
    	url : "/oneInqry/oneInqrySuccessList",
 	    ...
 	    success : function(res){
            ...
            if(length == 0){
            	str += "<td colspan='5' style='font-size:15pt;'>완료된 문의 내역이 없습니다.</td>";
	...
	<div class="card-body">
		<ul class="nav nav-tabs" role="tablist">
			<li class="nav-item" role="presentation"><a
				class="nav-link" id="all-tab" aria-controls="all-1" href="/oneInqry/oneInqryList"
				aria-selected="true">전체</a></li>
			<li class="nav-item" role="presentation"><a class="nav-link" 
				id="noAnswer-tab" href="/oneInqry/oneInqryNoAnswerList"
				aria-controls="noAnswer-1" aria-selected="false" tabindex="-1">미답변</a>
			</li>
			<li class="nav-item" role="presentation"><a class="nav-link active"
				id="success-tab" href="/oneInqry/oneInqrySuccessList"
