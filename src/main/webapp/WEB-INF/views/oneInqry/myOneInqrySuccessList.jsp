...
$(function(){
    ...
    $.ajax({
    	url : "/oneInqry/myOneInqrySuccessList",
 	    ...
 	    success : function(res){
            ...
            if(length == 0){
            	str += "<td colspan='5' style='font-size:15pt;'>답변이 완료된 문의 내역이 없습니다.</td>";
	...
	<div class="card-body">
		<ul class="nav nav-tabs" role="tablist">
			<li class="nav-item" role="presentation"><a
				class="nav-link" id="all-tab" aria-controls="all-1" href="/oneInqry/myOneInqryList"
