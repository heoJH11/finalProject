...
// 	console.log("passCk ", $("#passCk"));
	$("#passCk").on("keyup", function (key) {
// 		console.log("엔터1", key.keyCode);
        if(key.keyCode == 13) {
//         	alert("엔터2");
        	passCkEvent();
        }
...
let passCkEvent = function(){
	...
	var sessionPass = document.getElementById("sessionPass").value;
// 	console.log(passCk + "/" `1+ sessionPass);
          ...
          <div class="col-lg-4 mx-auto">
            ...
            <div class="auth-form-transparent text-left p-5 text-center">
				...
				<c:if test="${not empty memSession.profile}">
					<img src="${memSession.profile}" class="lock-profile-img" alt="img"/>
				</c:if>
<!--               <form class="pt-5"> -->
                <div class="form-group">
                  ...
                  <input type="password" style="font-family: 'GmarketSansMedium'; border-radius:20px; border: 1px solid white; color: white; width:400px; height:40px; text-align:center; font-size: 15px; background-color:transparent;" id="passCk" placeholder="비밀번호 입력">
                </div>
                <div class="mt-5">
